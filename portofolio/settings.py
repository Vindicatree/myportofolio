...
SECRET_KEY = 'django-insecure-p!x1dzm+1j6l=6-qyeob4h%*mik$q!6y8(+y8cc9&%rr$m7p+o'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "nathanael-orrick-myportofolio.pws.cs.ui.ac.id"]
...
CSRF_TRUSTED_ORIGINS = ["https://nathanael-orrick-myportofolio.pws.cs.ui.ac.id"]